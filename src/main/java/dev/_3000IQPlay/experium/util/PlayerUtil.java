...
public class PlayerUtil implements Util
{
    ...
    public static class lookUpUUID implements Runnable
    {
        ...
        public void run() {
            ...
            try {
                final ArrayList<NetworkPlayerInfo> infoMap = new ArrayList<NetworkPlayerInfo>(Objects.requireNonNull(PlayerUtil.mc.getConnection()).getPlayerInfoMap());
    ...
    public static class lookUpName implements Runnable
    {
        ...
        public String lookUpName() {
            ...
            if (PlayerUtil.mc.world != null) {
                player = PlayerUtil.mc.world.getPlayerEntityByUUID(this.uuidID);
            }
            if (player == null) {
