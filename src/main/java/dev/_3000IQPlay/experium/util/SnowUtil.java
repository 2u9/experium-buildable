...
public final class SnowUtil
{
    ...
    public static void updateModelViewProjectionMatrix() {
        ...
        GLUProjection.getInstance().updateMatrices(SnowUtil.VIEWPORT, SnowUtil.MODELVIEW, SnowUtil.PROJECTION, res.getScaledWidth() / (float)Minecraft.getMinecraft().displayWidth, res.getScaledHeight() / (float)Minecraft.getMinecraft().displayHeight);
    }
