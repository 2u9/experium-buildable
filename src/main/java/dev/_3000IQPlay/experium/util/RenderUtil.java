...
implements Util {
    ...
    public static void drawSexyBox(AxisAlignedBB a, Color boxColor, Color outlineColor, float lineWidth, boolean outline, boolean box, boolean colorSync, float alpha, float scale, float slab) {
    ...
    public static void drawText(AxisAlignedBB pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate((double)(-((double)Experium.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
