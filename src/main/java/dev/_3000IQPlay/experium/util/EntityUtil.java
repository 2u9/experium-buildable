...
public class EntityUtil implements Util
{
    ...
    public static boolean isObbyHole(final BlockPos blockPos) {
        ...
        final BlockPos[] array = array2 = new BlockPos[] { blockPos.north(), blockPos.south(), blockPos.east(), blockPos.west(), blockPos.down() };
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || (entity instanceof EntityPlayer && Experium.friendManager.isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            ...
            output.put((Object)healthSB + " " + (Experium.friendManager.isFriend(player) ? "§b" : "§r") + player.getName() + " " + (Object)distanceSB + " §f" + Experium.totemPopManager.getTotemPopString(player) + Experium.potionManager.getTextRadarPotion(player), (int)EntityUtil.mc.player.getDistance((Entity)player));
