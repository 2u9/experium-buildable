...
extends Module {
    ...
    private final Setting<Float> scaling = this.register(new Setting<Float>("Size", Float.valueOf(3.0f), Float.valueOf(0.1f), Float.valueOf(20.0f)));
    ...
    private final Setting<Integer> redSetting = this.register(new Setting<Object>("Red", Integer.valueOf(100), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    private final Setting<Integer> greenSetting = this.register(new Setting<Object>("Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    private final Setting<Integer> blueSetting = this.register(new Setting<Object>("Blue", Integer.valueOf(240), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    ...
    private final Setting<Float> lineWidth = this.register(new Setting<Object>("LineWidth", Float.valueOf(0.3f), Float.valueOf(0.1f), Float.valueOf(5.0f), v -> this.outline.getValue()));
    ...
    private final Setting<Boolean> onlyFov = this.register(new Setting<Boolean>("OnlyFov", true));
    ...
    private void renderEnchantmentText(EntityPlayer player, ItemStack stack, int x) {
        int enchantmentY = (int)(-34.0f - (this.topEnchant.getValue() != false ? this.getBiggestArmorTag(player) - this.getEnchantHeight(stack) : 0.0f));
    ...
    private float getBiggestArmorTag(EntityPlayer player) {
        ...
        return (float)(arm2 ? 0 : 20) + enchantmentY;
    }
