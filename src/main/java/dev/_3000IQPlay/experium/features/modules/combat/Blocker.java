...
public class Blocker extends Module
{
    ...
    public Blocker() {
        super("Blocker", "Anti-PistonFag.class", Category.COMBAT, true, false, false);
    ...
    public void onTick() {
        ...
        if (this.cev.getValue()) {
            ...
            if (this.b_cev != null && this.getBlock(this.b_cev).getBlock() == Blocks.AIR) {
                ...
                if (crystal == null) {
                    final BlockPos blockPos = new BlockPos(Blocker.mc.player.posX, (double)this.b_cev.getY(), Blocker.mc.player.posZ);
