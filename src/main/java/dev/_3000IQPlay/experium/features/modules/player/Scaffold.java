...
extends Module {
    ...
    public void onUpdate() {
        if (this.mode.getValue() == Mode.New) {
            ...
            if (this.replenishBlocks.getValue().booleanValue() && !(Scaffold.mc.player.getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemBlock) && this.getBlockCountHotbar() <= 0 && this.itemTimer.passedMs(100L)) {
                for (int i = 9; i < 45; ++i) {
                    ItemStack itemStack;
                    if (!Scaffold.mc.player.inventoryContainer.getSlot(i).getHasStack() || !((itemStack = Scaffold.mc.player.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemBlock) || this.invalid.contains((Object)Block.getBlockFromItem((Item)itemStack.getItem())) || i >= 36) continue;
            ...
            if (blockData != null) {
                ...
                if (this.bSwitch.getValue().booleanValue()) {
                    for (int i = 0; i < 9; ++i) {
                        ...
                        if (Scaffold.mc.player.inventory.getStackInSlot(i).getCount() == 0 || !(Scaffold.mc.player.inventory.getStackInSlot(i).getItem() instanceof ItemBlock) || this.invalid.contains((Object)((ItemBlock)Scaffold.mc.player.inventory.getStackInSlot(i).getItem()).getBlock())) continue;
    ...
    private int getBlockCountHotbar() {
        ...
        for (int i = 36; i < 45; ++i) {
            ...
            if (!(itemStack.getItem() instanceof ItemBlock) || this.invalid.contains((Object)((ItemBlock)item).getBlock())) continue;
    ...
    private BlockData getBlockData2(BlockPos blockPos) {
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos2.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos2.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos2.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos2.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos2.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos2.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos2.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos2.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos2.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos3.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos3.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos3.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos3.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos3.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos3.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos3.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos3.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos3.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos4.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos4.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos4.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos4.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos4.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos4.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos4.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos4.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos4.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos5.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos5.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos5.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos5.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos5.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos5.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos5.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos5.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos5.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos10.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos10.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos10.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos10.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos10.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos10.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos10.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos10.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos10.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos11.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos11.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos11.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos11.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos11.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos11.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos11.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos11.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos11.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos12.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos12.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos12.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos12.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos12.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos12.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos12.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos12.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos12.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos13.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos13.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos13.add(-1, 0, 0)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos13.add(0, 0, 1)).getBlock())) {
        ...
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos14.add(0, -1, 0)).getBlock())) {
            return new BlockData(blockPos14.add(0, -1, 0), EnumFacing.UP);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos14.add(0, 1, 0)).getBlock())) {
            return new BlockData(blockPos14.add(0, 1, 0), EnumFacing.DOWN);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos14.add(-1, 0, 0)).getBlock())) {
            return new BlockData(blockPos14.add(-1, 0, 0), EnumFacing.EAST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos14.add(1, 0, 0)).getBlock())) {
            return new BlockData(blockPos14.add(1, 0, 0), EnumFacing.WEST);
        }
        if (!this.invalid.contains((Object)Scaffold.mc.world.getBlockState(blockPos14.add(0, 0, 1)).getBlock())) {
    ...
    public void place(BlockPos blockPos, EnumFacing enumFacing) {
        ...
        n = 0;
        if (!Scaffold.mc.player.isSneaking() && BlockUtil.blackList.contains((Object)Scaffold.mc.world.getBlockState(blockPos2).getBlock())) {
