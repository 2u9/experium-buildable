...
public class Managers extends Module
{
    ...
    public Managers() {
        ...
        this.command = (Setting<String>)this.register(new Setting("Command", (T)"Experium"));
        this.rainbowPrefix = (Setting<Boolean>)this.register(new Setting("RainbowPrefix", (T)false));
        this.bracketColor = (Setting<TextUtil.Color>)this.register(new Setting("BColor", (T)TextUtil.Color.WHITE));
        this.commandColor = (Setting<TextUtil.Color>)this.register(new Setting("CColor", (T)TextUtil.Color.LIGHT_PURPLE));
