...
public class AutoCrystal extends Module
{
    ...
    public AutoCrystal() {
        ...
        this.placeDelay = (Setting<Integer>)this.register(new Setting("PlaceDelay", (T)10, (T)0, (T)500, v -> this.setting.getValue() == Settings.PLACE && this.place.getValue()));
        ...
        this.antiWeakness = (Setting<AntiWeaknessMode>)this.register(new Setting("Anti Weakness", (T)AntiWeaknessMode.Silent, v -> this.setting.getValue() == Settings.BREAK && this.explode.getValue()));
        ...
        this.manual = (Setting<Boolean>)this.register(new Setting("Manual", (T)Boolean.FALSE, v -> this.setting.getValue() == Settings.BREAK));
        ...
        this.moveSpeed = (Setting<Float>)this.register(new Setting("Speed", (T)1000.0f, (T)0.0f, (T)1500.0f, v -> this.setting.getValue() == Settings.RENDER && this.renderMode.getValue() == RenderMode.GLIDE && this.render.getValue()));
        ...
        this.bRed = (Setting<Integer>)this.register(new Setting("BoxRed", (T)100, (T)0, (T)255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        ...
        this.bBlue = (Setting<Integer>)this.register(new Setting("BoxBlue", (T)240, (T)0, (T)255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        ...
        this.oRed = (Setting<Integer>)this.register(new Setting("OutlineRed", (T)100, (T)0, (T)255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.oGreen = (Setting<Integer>)this.register(new Setting("OutlineGreen", (T)0, (T)0, (T)255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.oBlue = (Setting<Integer>)this.register(new Setting("OutlineBlue", (T)240, (T)0, (T)255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        ...
        this.timing = (Setting<Timing>)this.register(new Setting("Timing", (T)Timing.Sequential, v -> this.setting.getValue() == Settings.MISC));
        ...
        this.autoSwitch = (Setting<AutoSwitch>)this.register(new Setting("Switch", (T)AutoSwitch.SILENT, v -> this.setting.getValue() == Settings.MISC));
    ...
    public void onSoundPacket(final PacketEvent.Receive event) {
        ...
        final SPacketSoundEffect packet2;
        if (event.getPacket() instanceof SPacketSoundEffect && this.timing.getValue() == Timing.Sequential && (packet2 = event.getPacket()).getCategory() == SoundCategory.BLOCKS && packet2.getSound() == SoundEvents.ENTITY_GENERIC_EXPLODE) {
            final ArrayList entities = new ArrayList(AutoCrystal.mc.world.loadedEntityList);
            for (int size = entities.size(), i = 0; i < size; ++i) {
                final Entity entity = entities.get(i);
                if (entity instanceof EntityEnderCrystal) {
                    if (entity.getDistanceSq(packet2.getX(), packet2.getY(), packet2.getZ()) < 36.0) {
                        entity.setDead();
                    }
                }
            }
            ...
            if (packet2.getType() == 51 && AutoCrystal.mc.player.getDistanceSq(pos = new BlockPos(packet2.getX(), packet2.getY(), packet2.getZ())) + this.predictOffset.getValue() <= MathUtil.square(this.breakRange.getValue()) && (this.instantTimer.getValue() == PredictTimer.NONE || (this.instantTimer.getValue() == PredictTimer.BREAK && this.breakTimer.passedMs(this.breakDelay.getValue())) || (this.instantTimer.getValue() == PredictTimer.PREDICT && this.predictTimer.passedMs(this.predictDelay.getValue())))) {
                ...
                if (this.predictFriendDmg.getValue() && (this.antiFriendPop.getValue() == AntiFriendPop.BREAK || this.antiFriendPop.getValue() == AntiFriendPop.ALL) && this.isRightThread()) {
                    for (final EntityPlayer friend : AutoCrystal.mc.world.playerEntities) {
                        if (friend != null && !AutoCrystal.mc.player.equals((Object)friend) && friend.getDistanceSq(pos) <= MathUtil.square(this.range.getValue() + this.placeRange.getValue()) && Experium.friendManager.isFriend(friend)) {
    ...
    private boolean isRightThread() {
        return AutoCrystal.mc.isCallingFromMinecraftThread() || (!Experium.eventManager.ticksOngoing() && !this.threadOngoing.get());
    }
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        if ((this.offHand || this.mainHand || this.switchMode.getValue() == Switch.CALC) && this.renderPos != null && (this.box.getValue() || this.outline.getValue())) {
            ...
            if (this.renderMode.getValue() == RenderMode.STATIC) {
                RenderUtil.drawSexyBox(new AxisAlignedBB(this.renderPos), boxC, outlineC, this.lineWidth.getValue(), this.outline.getValue(), this.box.getValue(), this.colorSync.getValue(), 1.0f, 1.0f, this.slabHeight.getValue());
            }
            if (this.renderMode.getValue() == RenderMode.GLIDE) {
                ...
                RenderUtil.drawSexyBox(this.renderBB = this.renderBB.offset(xDiff * multiplier, yDiff * multiplier, zDiff * multiplier), boxC, outlineC, this.lineWidth.getValue(), this.outline.getValue(), this.box.getValue(), this.colorSync.getValue(), 1.0f, 1.0f, this.slabHeight.getValue());
        ...
        if (this.renderMode.getValue() == RenderMode.FADE) {
            ...
            this.positions.forEach(pos -> {
                ...
                RenderUtil.drawSexyBox(new AxisAlignedBB(pos.getPos()), boxColor, outlineColor, this.lineWidth.getValue(), this.outline.getValue(), this.box.getValue(), this.colorSync.getValue(), ((boolean)this.fadeFactor.getValue()) ? factor : 1.0f, ((boolean)this.scaleFactor.getValue()) ? factor : 1.0f, ((boolean)this.slabFactor.getValue()) ? factor : 1.0f);
                    ...
                    if (selfDamage + 0.5 < EntityUtil.getHealth((Entity)AutoCrystal.mc.player) && selfDamage <= this.maxSelfBreak.getValue()) {
                        ...
                        for (final EntityPlayer player : AutoCrystal.mc.world.playerEntities) {
                            ...
                            if (EntityUtil.isValid((Entity)player, this.range.getValue() + this.breakRange.getValue())) {
                                ...
                                if ((this.antiFriendPop.getValue() != AntiFriendPop.BREAK && this.antiFriendPop.getValue() != AntiFriendPop.ALL) || !Experium.friendManager.isFriend(player.getName())) {
                                    continue;
                                }
            ...
            if (targettedPlayer != null) {
                ...
                for (final EntityPlayer player : AutoCrystal.mc.world.playerEntities) {
                    if (EntityUtil.isValid((Entity)player, this.placeRange.getValue() + this.range.getValue())) {
                        ...
                        if ((this.antiFriendPop.getValue() != AntiFriendPop.ALL && this.antiFriendPop.getValue() != AntiFriendPop.PLACE) || player == null || player.getDistanceSq(pos) > MathUtil.square(this.range.getValue() + this.placeRange.getValue()) || !Experium.friendManager.isFriend(player)) {
                            continue;
                        }
    ...
    private void breakCrystal() {
        ...
        if (this.explode.getValue() && this.breakTimer.passedMs(this.breakDelay.getValue()) && (this.switchMode.getValue() == Switch.ALWAYS || this.mainHand || this.offHand)) {
            if (this.packets.getValue() == 1 && this.efficientTarget != null) {
                ...
                if ((!this.offHand && !this.mainHand && this.switchMode.getValue() == Switch.BREAKSLOT && !this.switching) || !DamageUtil.canBreakWeakness((EntityPlayer)AutoCrystal.mc.player) || (!this.switchTimer.passedMs(this.switchCooldown.getValue()) && this.antiWeakness.getValue() != AntiWeaknessMode.None)) {
