...
public class AutoBuilder extends Module
{
    ...
    public AutoBuilder() {
        ...
        this.bRed = (Setting<Integer>)this.register(new Setting("BoxRed", (T)135, (T)0, (T)255, v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        ...
        this.bBlue = (Setting<Integer>)this.register(new Setting("BoxBlue", (T)255, (T)0, (T)255, v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        ...
        this.oRed = (Setting<Integer>)this.register(new Setting("OutlineRed", (T)135, (T)0, (T)255, v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        this.placepositions.forEach(pos -> RenderUtil.drawSexyBox(new AxisAlignedBB(pos), box, outline, this.lineWidth.getValue(), this.outline.getValue(), this.box.getValue(), this.colorSync.getValue(), 1.0f, 1.0f, 1.0f));
    }
    ...
    private void doAutoBuilder() {
        ...
        for (final BlockPos pos : this.placepositions) {
            ...
            if (canPlace == 3) {
                ...
                if (canPlace != 2 || this.mode.getValue() != Mode.STAIRS) {
                    continue;
                }
