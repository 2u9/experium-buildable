...
extends Module {
    ...
    private final Setting<Integer> bRed = this.register(new Setting<Integer>("BoxRed", Integer.valueOf(135), Integer.valueOf(0), Integer.valueOf(255), v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() != false && this.box.getValue() != false));
    ...
    private final Setting<Integer> bBlue = this.register(new Setting<Integer>("BoxBlue", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() != false && this.box.getValue() != false));
    ...
    private final Setting<Integer> oRed = this.register(new Setting<Integer>("OutlineRed", Integer.valueOf(135), Integer.valueOf(0), Integer.valueOf(255), v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() != false && this.outline.getValue() != false));
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        this.placepositions.forEach(pos -> RenderUtil.drawSexyBox(new AxisAlignedBB(pos), box, outline, this.lineWidth.getValue().floatValue(), this.outline.getValue(), this.box.getValue(), this.colorSync.getValue(), 1.0f, 1.0f, 1.0f));
    }
    ...
    private void getPositions() {
        ...
        for (BlockPos pos : BlockUtil.getSphere(new BlockPos(AutoBuilder.mc.player.posX, Math.ceil(AutoBuilder.mc.player.posY), AutoBuilder.mc.player.posZ).up(), this.range.getValue().floatValue(), this.range.getValue().intValue(), false, true, 0)) {
            if (this.placepositions.contains((Object)pos) || !AutoBuilder.mc.world.isAirBlock(pos)) continue;
