...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (this.stage == 0) {
            ...
            for (int a : this.map) {
                ...
                if ((PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRENGTH) || PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRONG_STRENGTH) || PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.LONG_STRENGTH)) && this.strSlot == -1) {
                    this.strSlot = a;
                }
                if (!PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.SWIFTNESS) && !PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.LONG_SWIFTNESS) && !PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRONG_SWIFTNESS) || this.speedSlot != -1) continue;
                this.speedSlot = a;
            }
            ++this.stage;
    ...
    private void switchTo(Enum<mainEnum> mode2) {
        if (mode2.toString().equalsIgnoreCase("STRENGTH") && this.strSlot != -1) {
            this.switchTo(this.strSlot);
        }
        if (mode2.toString().equalsIgnoreCase("SPEED") && this.speedSlot != -1) {
    ...
    private ArrayList<Integer> mapArrows() {
        ...
        for (int a = 9; a < 45; ++a) {
            ...
            ItemStack arrow = (ItemStack)Quiver.mc.player.inventoryContainer.getInventory().get(a);
            if (PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRENGTH) || PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRONG_STRENGTH) || PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.LONG_STRENGTH)) {
                map.add(a);
            }
            if (!PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.SWIFTNESS) && !PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.LONG_SWIFTNESS) && !PotionUtils.getPotionFromItem((ItemStack)arrow).equals((Object)PotionTypes.STRONG_SWIFTNESS)) continue;
            map.add(a);
        }
        return map;
    }
