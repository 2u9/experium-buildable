    ...
    public void execute(final String[] commands) {
        if (commands.length == 1) {
            ...
            for (final Module.Category category : Experium.moduleManager.getCategories()) {
                ...
                for (final Module module : Experium.moduleManager.getModulesByCategory(category)) {
        ...
        Module module2 = Experium.moduleManager.getModuleByDisplayName(commands[0]);
        if (module2 == null) {
            module2 = Experium.moduleManager.getModuleByName(commands[0]);
            if (module2 == null) {
