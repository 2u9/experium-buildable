...
public abstract class MixinEntity {
    ...
    @Overwrite
    public void move(MoverType type2, double x, double y, double z) {
        ...
        if (this.noClip) {
            ...
            double d3 = y;
            double d4 = z;
            if ((type2 == MoverType.SELF || type2 == MoverType.PLAYER) && this.onGround && this.isSneaking() && _this instanceof EntityPlayer) {
                double d5 = 0.05;
