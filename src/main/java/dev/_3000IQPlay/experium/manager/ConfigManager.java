...
public class ConfigManager implements Util
{
    ...
    public void loadConfig(final String name) {
        ...
        final List<File> files = Arrays.stream((Object[])Objects.requireNonNull((T[])new File("experium").listFiles())).filter(File::isDirectory).collect((Collector<? super Object, ?, List<File>>)Collectors.toList());
    ...
    public void saveCurrentConfig() {
        final File currentConfig = new File("experium/currentconfig.txt");
        try {
